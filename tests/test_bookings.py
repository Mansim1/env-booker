...
def test_overlapping_booking(client):
    ...
    with client.application.app_context():
        ...
        db.session.commit()
    resp = post_booking(client, 1, "2025-06-01 10:00", "2025-06-01 12:00")
